...
ColumnLine.prototype.trimmed = function(to_length, wrap, raw_line, offset, total_length, lineArray) {
    ...
    offset += to_length - i;
    if (wrap === true && total_length > offset) {
        this.trimmed(to_length, wrap, raw_line, offset, total_length, lineArray);
    }
